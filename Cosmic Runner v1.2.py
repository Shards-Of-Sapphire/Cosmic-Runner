...
class Game:
    def __init__(self):
        ...
        self.checkpoint_cooldown = 1000  # Spawn checkpoint less frequently than obstacles
        self.current_checkpoint_biome = None  # The biome of the last checkpoint reached
        self.has_checkpoint = False  # Whether player has reached a checkpoint in current biome
    ...
    def handle_player_death(self):
        if self.lives > 1:
            ...
            if self.current_checkpoint_biome is not None:
                ...
                # Update environment based on checkpoint
